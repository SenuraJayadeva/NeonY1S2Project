...
<head>
    ...
    <title>MESH | DELETE SUCCESS</title>
  ...
  <div class='dropdown-content'>
    ...
    <div class="contactSuccessMsg">
        <div class="successImg">
            <img id="msgSuccessImg" src=" Images/deleteUserN.png">
        </div>
        <div class="verifyed">
            <img src=" Images/verified.png" id="verify">
        </div>
        <div class="sucessMsg">
            <p id="EditLec_sucessMsgPara">ACCOUNT DELETED SUCCESSFULLY. <br> WE ARE SORRY TO SEE YOU GO.</p>
            <a href="index.php"><button class="bnBack">BACK TO HOME PAGE</button></a>
        </div>
    </div>
