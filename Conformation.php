        ...
        <table>
            ...
            <td>
                <h1 style="margin-left:120px">
                    Your Change Have Been Submitted!
                </h1>
                <a href="index.php"><button class="btn" type="button" name="FMP">HOME</button></a>
                <a href="userProfileStu.php"><button class="btn" type="button" name="FMP">VIEW TIME-TABLE</button></a>
                <a href="contact.php"><button class="btn" type="button" name="FMP">GET HELP</button></a>
            </td>
        </table>
    </div>
</body>
