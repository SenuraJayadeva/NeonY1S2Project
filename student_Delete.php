...
<head>
    <link rel="StyleSheet" type="text/css" href="css/student_delete.css">
...
<div id="navigation_bar">
  ...
  <div class='dropdown-content'>
    ...
    <section id="student-update-page" class = "bodStInsert">
    <br>
          ...
          <tr>
            ...
            $database = 'mesh';
              ...
              {     
                    ...
                    {
                        echo "<tr><td>".$row["UserID"]."</td><td>".$row["fname"]."</td><td>".$row["age"]."</td><td>".$row["faculty"]."</td><td>".$row["year"]."</td><td>".$row["grp"]."</td><td>".$row["email"]."</td><td>".$row["pnum"]."</td><td><a href='delete_data.php?SID=$row[UserID]'><button>Delete</button></a></td></tr>";
                    }
