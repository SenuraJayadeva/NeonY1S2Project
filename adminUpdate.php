...
<div class="Lecturerupdateform">
             ...
             <form id="admin_update-update-form" method="POST" action="admin_updatenew.php" onsubmit="return validateLecturerInsertPage()">
                 <h2>Update Record</h2>
                 <input class="lecturer_update-form-inputs" type="text" name="AdminID" id="AdminID" value="<?php echo $_GET['Aid']; ?>" > <br>
                 <input class="lecturer_update-form-inputs" type="text" name="Adminfullname" id="Adminfullname" value="<?php echo $_GET['Aname']; ?>"><br>
                 <input class="lecturer_update-form-inputs" type="number" name="AdminAge" id="AdminAge" value="<?php echo $_GET['Aage']; ?>" ><br>
                 <input class="lecturer_update-form-inputs" type="text" name="AdminContact" id="AdminContact" value="<?php echo $_GET['AContact']; ?>" ><br>
                 <input class="lecturer_update-form-inputs" type="email" name="AdminEmail" id="AdminEmail" value="<?php echo $_GET['Aemail']; ?>" ><br>
                 <input class="lecturer_update-form-inputs"  id="updateform-button" type="submit" name="submit" >
