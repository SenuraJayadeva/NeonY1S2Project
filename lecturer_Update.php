          ...
          <tr>
            ...
            $database = 'mesh';
              ...
              {     
                    ...
                    {
                        echo "<tr><td>".$row["userID"]."</td><td>".$row["LecturerName"]."</td><td>".$row["LecturerAge"]."</td><td>".$row["LecturerEmail"]."</td><td>".$row["LecturerContact"]."</td><td>".$row["LecturerFacluty"]."</td><td>"."<img height='50' width ='50' src=".$row['ProfilePic'].">"."</td><td><a  href='update.php?Lid=$row[userID]&Lname=$row[LecturerName]&Lage=$row[LecturerAge]&Lemail=$row[LecturerEmail]&Lcontact=$row[LecturerContact]&Lfaculty=$row[LecturerFacluty]'><button id='lecturer-update-page-edit'>EDIT</button></a></td></tr>";
                    }
