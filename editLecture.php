  ...
  <div class='dropdown-content'>
    ...
    <div class="contactSuccessMsg">
        <div class="successImg">
            <img id="msgSuccessImg" src=" Images/sorry.png">
        </div>
        <div class="verifyed">
            <img src=" Images/cancel.png" id="verify">
        </div>
        <div class="sucessMsg">
            <p id="EditLec_sucessMsgPara">LECTURERS HAVE TO CONTACT DATABASE ADMINSITRATOR TO CHANGE THEIR USER INFORMATION</p>
            <a href="userprofileLec.php"><button class="bnBack">BACK TO USER PROFILE</button></a>
        </div>
    </div>
